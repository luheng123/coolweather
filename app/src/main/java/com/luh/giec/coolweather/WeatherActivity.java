...
import com.luh.giec.coolweather.gson.Forecast;
import com.luh.giec.coolweather.gson.Weather;
import com.luh.giec.coolweather.util.HttpUtil;
import com.luh.giec.coolweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=7e0742de6afb4d31848b6491ee60f058";
    ...
    private void loadBingPic() {
        String requesetBingPic = "http://guolin.tech/api/bing_pic";
        HttpUtil.sendOkHttpRequest(requesetBingPic, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
            }
